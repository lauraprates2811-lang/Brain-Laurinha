# Projeto — Cursinho (material)

Hub da pasta de material do cursinho. A ficha de estado da área é `Areas/Cursinho.md`.
...
assunto (ex.: `crise-de-1929-e-nazifascismo.md`). As 13 pastas já existem.
